...
%-----------Lemonate-----------
\resumeSubheading
    {\href{https://lemonate.io/}{Lemonate}}{April 2025 -- Present}
    {Senior Software Engineer}{Schaffhausen, CH (Remote)}
    \resumeItemListStart
      \resumeItem{Architecting and implementing enterprise-scale 3D scanning, data hosting, and publishing infrastructure for a comprehensive web-based 3D rendering engine.}
      \resumeItem{Driving core development of Lemonate's interactive 3D platform, enabling real-time rendering and deployment of complex 3D applications directly in web browsers.}
      \resumeItem{Implementing advanced rendering algorithms and performance optimizations for Lemonate's proprietary WebGL engine, supporting cross-platform 3D content creation and visualization.}
      \resumeItem{Contributing to engine architecture decisions and developing tools for seamless 3D workflow integration across web environments.}
    \resumeItemListEnd
